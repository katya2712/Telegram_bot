...
with open('secrets/telegram.key') as file:
    ...
    def start(message):
        ...
        item5 = KeyboardButton('/\U0001F51DТоп фильмов')
    ...
    3️⃣После того как вы выбрали, что вы хотите посмотреть, вам ббудет предложено удут предложены ещё три кнопки: жанр, актёры и режиссёр. Нажмите на любую из них и напишите любимый жанр, актёра или режиссёра. Затем вам несколько фильмов, vмультфильмов или сериалов, выберете один из них, запаситесь вкусняшками и наслаждайтесь просмотром!\U0001F497
    ...
    @bot.message_handler(commands=['popular', '\U0001F51DТоп фильмов'])
